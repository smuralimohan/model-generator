...
/**
 * KitchenMenuItemAuditId generated by hbm2java
 */
public class KitchenMenuItemAuditId implements java.io.Serializable {
	...
	public KitchenMenuItemAuditId() {
	}

	public KitchenMenuItemAuditId(Character action, Long id, Long menuId, String name, Double price, String currency,
			Integer calories, Integer serves, Integer spicyRating, String description, Serializable itemType,
			Serializable itemSubtype, Date updatedAt, Long updatedBy) {
		this.action = action;
		this.id = id;
		this.menuId = menuId;
		this.name = name;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KitchenMenuItemAuditId))
			return false;
		KitchenMenuItemAuditId castOther = (KitchenMenuItemAuditId) other;
		...
		return ((this.getAction() == castOther.getAction()) || (this.getAction() != null
				...
				&& ((this.getCalories() == castOther.getCalories()) || (this.getCalories() != null
						&& castOther.getCalories() != null && this.getCalories().equals(castOther.getCalories())))
				&& ((this.getServes() == castOther.getServes()) || (this.getServes() != null
						&& castOther.getServes() != null && this.getServes().equals(castOther.getServes())))
				&& ((this.getSpicyRating() == castOther.getSpicyRating())
						|| (this.getSpicyRating() != null && castOther.getSpicyRating() != null
								&& this.getSpicyRating().equals(castOther.getSpicyRating())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getCalories() == null ? 0 : this.getCalories().hashCode());
		result = 37 * result + (getServes() == null ? 0 : this.getServes().hashCode());
		result = 37 * result + (getSpicyRating() == null ? 0 : this.getSpicyRating().hashCode());

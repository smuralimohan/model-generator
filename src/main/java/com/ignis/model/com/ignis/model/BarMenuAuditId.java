...
/**
 * BarMenuAuditId generated by hbm2java
 */
public class BarMenuAuditId implements java.io.Serializable {
	...
	public BarMenuAuditId() {
	}

	public BarMenuAuditId(Character action, Long id, Long establishmentId, String name, Serializable type,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BarMenuAuditId))
			return false;
		BarMenuAuditId castOther = (BarMenuAuditId) other;

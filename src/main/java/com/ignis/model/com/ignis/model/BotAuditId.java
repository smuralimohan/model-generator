...
/**
 * BotAuditId generated by hbm2java
 */
public class BotAuditId implements java.io.Serializable {
	...
	public BotAuditId(Character action, Long id, Long sessionId, Long menuItemId, String qty, Date updatedAt,
			Long updatedBy) {
		this.action = action;
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BotAuditId))
			return false;
		BotAuditId castOther = (BotAuditId) other;

...
/**
 * TaxEntityId generated by hbm2java
 */
public class TaxEntityId implements java.io.Serializable {
	...
	public TaxEntityId(Long taxId, Long entityId, Date startDate, Date endDate, Boolean isActive, Date updatedAt,
			Long updatedBy) {
		this.taxId = taxId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaxEntityId))
			return false;
		TaxEntityId castOther = (TaxEntityId) other;

		return ((this.getTaxId() == castOther.getTaxId()) || (this.getTaxId() != null && castOther.getTaxId() != null
				&& this.getTaxId().equals(castOther.getTaxId())))
